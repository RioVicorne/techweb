...
export const ORDER_STATUS_TABS: OrderStatusTabDef[] = [
  ...
  { key: "preparing", label: "Đang chuẩn bị", icon: "inventory_2", statuses: ["CONFIRMED"] },
  { key: "shipping", label: "Đang giao", icon: "local_shipping", statuses: ["SHIPPING"] },
  { key: "delivered", label: "Hoàn tất", icon: "verified", statuses: ["COMPLETED"] },
