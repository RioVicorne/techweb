...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      {/* Mobile view (Stitch-like): 1 column, tonal layers, chips + vertical cards */}
        ...
        <main className="mx-auto max-w-screen-2xl px-5 pb-20 pt-24">
          <section className="relative mb-6 h-[235px] overflow-hidden rounded-3xl">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(to top, var(--stitch-color-surface) 0%, transparent 58%)",
              }}
            />
              ...
              {PRODUCTS.slice(0, 2).map((p) => (
                ...
                >
                  ...
                  <div className="flex gap-4 pt-10">
                    ...
                    >
                      <Image src={p.img} alt={p.title} fill className="object-cover" sizes="80px" unoptimized />
                    </Link>
