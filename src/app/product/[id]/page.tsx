      ...
      <main className="mx-auto max-w-screen-2xl px-5 pb-28 pt-24 md:px-12">
        ...
        <section className="mb-6">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              <StarRow filled={product.stars} reviews={product.reviews} />
              <h1
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            <details
              className="group rounded-3xl p-4"
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        ...
                        style={{ background: "color-mix(in srgb, var(--stitch-color-secondary) 20%, transparent)", color: "var(--stitch-color-on-surface-variant)" }}
                      >
                        {r.role}
                      </span>
                    </div>
